...
def parse_args():
    ...
    parser.add_argument('--gt_path', default='/data/dataset1/wj/mmediting/data/vimeo_super_resolution_test/low_resolution', help='GT path for Vimeo90K')
    parser.add_argument('--lq_path', default='/data/dataset1/wj/mmediting/data/vimeo_super_resolution_test/target', help='LQ path for Vimeo90K')
    parser.add_argument(
