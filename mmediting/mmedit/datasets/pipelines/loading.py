...
class LoadImageFromFileList(LoadImageFromFile):
    ...
    def __call__(self, results):
        ...
        #print('results:',results)
            #results: {'lq_path': 'data/reds/traffic/train2/trans_bicubic/X4/', 
            #'gt_path': 'data/reds/traffic/train2/trans',
            #'key': '133/00000034', 'max_frame_num': 100, 
            #'num_input_frames': 5, 'scale': 4}

        #print('self.key:',self.key)#self.key: lq
        #print('filepaths:',filepaths)#data/reds/traffic/train2/trans_bicubic/X4
        #filepaths=(f'{filepaths}/*')#filepath should be list, but got <class 'str'>
