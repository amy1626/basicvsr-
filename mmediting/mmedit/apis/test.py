...
def single_gpu_test(model,
    ...
    # print(data_loader)  #<torch.utils.data.dataloader.DataLoader object at 0x7f826bb6d040>
    # print(len(dataset))
    # print(dataset)  #<mmedit.datasets.sr_vimeo90k_dataset.SRVimeo90KDataset object at 0x7fd8126de820>
    prog_bar = mmcv.ProgressBar(len(dataset))#[         ] 0/7824, elapsed: 0s, ETA:

    #print('\nlen(data_loader):',len(data_loader))#7824
