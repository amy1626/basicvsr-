...
class BasicRestorer(BaseModel):
    ...
    def forward_train(self, lq, gt):#需要重写
        ...
        """
        losses = dict()
        output = self.generator(lq)#self.generator是模型
    ...
    def train_step(self, data_batch, optimizer):#需要重写
        """Train step.
