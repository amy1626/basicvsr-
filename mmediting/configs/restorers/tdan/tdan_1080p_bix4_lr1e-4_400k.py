exp_name = 'tdan_1080p_bix4_lr1e-4_400k'
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            lq_folder='data/reds/traffic/train2/trans_bicubic/X4',
            gt_folder='data/reds/traffic/train2/trans',
            ann_file='data/reds/traffic/train2/meta_info_REDS_GT.txt',
    ...
    val=dict(
        ...
        lq_folder='data/reds/traffic/valid_amy/Bicubic4xLR',
        gt_folder='data/reds/traffic/valid_amy/GT',
        ann_file='data/reds/traffic/valid_amy/meta_info_valid.txt',
    ...
    test=dict(
        ...
        lq_folder='data/reds/traffic/test_1080p/lr/X4',
        gt_folder='data/reds/traffic/test_1080p/gt',
        pipeline=val_pipeline,
        ann_file='data/reds/traffic/test_1080p/meta_info_1080p_GT.txt',
