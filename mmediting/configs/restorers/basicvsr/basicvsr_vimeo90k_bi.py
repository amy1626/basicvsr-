...
data = dict(
    ...
    test=dict(
        ...
        lq_folder='data/vimeo_super_resolution_test/low_resolution',
        gt_folder='data/vimeo_super_resolution_test/target',
        ann_file='data/vimeo_super_resolution_test/meta_info_Vimeo90K_GT.txt',
        
        # lq_folder='data/vimeo_jkvideos/low_resolution',
        # gt_folder='data/vimeo_jkvideos/input',
        # ann_file='data/vimeo_jkvideos/meta_info_Vimeo90K_GT.txt',
